...
public class SummonedCoralssus extends Coralssus_Entity implements IMagicSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedCoralssus(EntityType entity, Level world) {
        super(entity, world);
    }

    public SummonedCoralssus(Level level, LivingEntity owner) {
        this(CSEntityRegistry.SUMMONED_CORALSSUS.get(), level);
        setSummoner(owner);
    }
