...
public class AbyssalWarlockArmorItem extends ImbuableCSArmorItem {
    public AbyssalWarlockArmorItem(Type slot, Properties settings) {
        super(CSArmorMaterialRegistry.ABYSSAL_WARLOCK_ARMOR, slot, settings, schoolAttributesWithResistance(AttributeRegistry.FIRE_SPELL_POWER, AttributeRegistry.MANA_REGEN, 150, 0.15F, 0.05F, 0.05F));
    }
